...
##  วัตถุประสงค์
1. **เพื่อตรวจสอบความถูกต้องของฟังก์ชันการทำงาน** — ทดสอบว่าแต่ละฟังก์ชัน (ยืม-คืนหนังสือ, จัดการสมาชิก, คำนวณค่าปรับ ฯลฯ) ทำงานได้ถูกต้องตาม Requirements ที่กำหนด
2. **เพื่อสร้างระบบทดสอบอัตโนมัติ** — ฝึกเขียน Automated Test ด้วย Playwright ครอบคลุม Functional Testing, Security Testing และ Visual Regression Testing
3. **เพื่อค้นหาและวิเคราะห์จุดบกพร่องของระบบ** — ฝึกใช้เทคนิค Black Box Testing, Exploratory Testing และ Code Review เพื่อค้นหา bugs ที่ซ่อนอยู่ พร้อมเขียน Bug Report ที่มีคุณภาพ
4. **เพื่อทดสอบการทำงานข้ามแพลตฟอร์ม** — ตรวจสอบว่าระบบทำงานได้อย่างถูกต้องบน Chromium, Firefox และ WebKit ผ่านการรันเทสแบบ Multi-browser
5. **เพื่อพัฒนาทักษะด้านการประกันคุณภาพซอฟต์แวร์** — สร้างความเชี่ยวชาญในกระบวนการ QA ตั้งแต่การวางแผนทดสอบ, ออกแบบ Test Cases, บันทึกผลทดสอบ ไปจนถึงการจัดการ Bug Tracking
