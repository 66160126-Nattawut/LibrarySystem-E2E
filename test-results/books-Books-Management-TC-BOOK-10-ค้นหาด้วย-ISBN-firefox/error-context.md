...
- Name: books.spec.js >> Books Management >> TC-BOOK-10: ค้นหาด้วย ISBN
- Location: tests\e2e\books.spec.js:424:3
...
Call log:
  - waiting for locator('button').filter({ hasText: /Search|ค้นหา/i })
    - locator resolved to <button type="submit" class="btn btn-primary w-100">Search</button>
...
- generic [ref=e1]:
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e28]:
      - textbox "Search by title, author, or ISBN..." [active] [ref=e30]: 978-616-567-890-1
