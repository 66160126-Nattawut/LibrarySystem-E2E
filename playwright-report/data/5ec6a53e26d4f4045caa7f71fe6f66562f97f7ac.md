...
- Name: books.spec.js >> Books Management >> TC-BOOK-11: [BUG 17] ระบบต้องปฏิเสธ ISBN ที่ซ้ำ
- Location: tests\e2e\books.spec.js:439:3

# Error details

```
Error: [BUG 17 DETECTED] ต้องแสดง error เมื่อ ISBN ซ้ำ
...
```yaml
- generic [active] [ref=e1]: "Fatal error: Uncaught mysqli_sql_exception: Duplicate entry '978-1775444202931' for key 'books.isbn' in /var/www/html/book_add.php:25 Stack trace: #0 /var/www/html/book_add.php(25): mysqli_query(Object(mysqli), 'INSERT INTO boo...') #1 {main} thrown in /var/www/html/book_add.php on line 25"
```
