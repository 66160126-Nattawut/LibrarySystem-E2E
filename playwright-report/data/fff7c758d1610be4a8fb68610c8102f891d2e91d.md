...
```yaml
- generic [active] [ref=e1]: "Fatal error: Uncaught mysqli_sql_exception: Duplicate entry '978-1775444012504' for key 'books.isbn' in /var/www/html/book_add.php:25 Stack trace: #0 /var/www/html/book_add.php(25): mysqli_query(Object(mysqli), 'INSERT INTO boo...') #1 {main} thrown in /var/www/html/book_add.php on line 25"
```
